...
BUTTON_BOTTOM_LEFT_HIGHER1 = (BUTTON_MARGIN[0], SERVER_VIEW_HEIGHT - BUTTON_SIZE[1] - 2*BUTTON_MARGIN[1])
BUTTON_BOTTOM_LEFT_HIGHER2 = (BUTTON_MARGIN[0], SERVER_VIEW_HEIGHT - BUTTON_SIZE[1] - 2*BUTTON_MARGIN[1])
